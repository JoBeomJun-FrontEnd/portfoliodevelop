...
const Learn = () => {
  const learnElement: LearnCategory = {
    유튜브: ['HTML & CSS 강의 (2024.05)', '짐코딩에서 제공하는 유튜브 강의'],
    인프런: ['웹 개발 입문 활용편 (2024.06)', '짐코딩에서 제공하는 온라인 강의'],
    '드림코딩 아카데미': ['리액트 개념정리 (2024.07)', '드림코딩 아카데미에서 제공하는 온라인 강의'],
    '프론트엔드 프로젝트 캠프': ['React 2기 (2024.08 ~ 2024.09)', '웅진 x 스나이퍼팩토리에서 주최한 교육 프로그램'],
  };
        ...
        entries.forEach(entry => {
          ...
          if (categoryName) {
            setCategoryVisibility(prev => ({
              ...prev,
              [categoryName]: entry.isIntersecting && entry.intersectionRatio === 1.0,
            }));
          }
        });
      },
      {
        threshold: 1.0, // 요소가 완전히 들어와야 visible로 설정
      }
    );
